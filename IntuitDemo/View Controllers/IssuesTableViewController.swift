...
class IssuesTableViewController: UITableViewController {
    ...
    var useCaseIssueList: UseCaseIssueList!
    var repo: Repo!
    var issues: [Issue] = []
    ...
    override func viewDidLoad() {
        ...
        useCaseIssueList = UseCaseIssueList(repo: repo, issueRepository: appDelegate.issueRepository)
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return useCaseIssueList.issues.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let issue = useCaseIssueList.issues[indexPath.row]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "ShowIssueDetails" {
            ...
            if let index = tableView.indexPathForSelectedRow?.row {
                let detailsViewController = segue.destination as! IssueDetailsTableViewController
                detailsViewController.issue = useCaseIssueList.issues[index]
            }
        }
    }
}
